...
export function SearchResultPopup({
  ...
  return (
    <div
      ref={popupRef}
      className={`absolute bottom-24 left-1/2 -translate-x-1/2 z-20 w-125 max-h-80 rounded-2xl bg-black/60 backdrop-blur-md border border-white/10 shadow-xl overflow-hidden transition-opacity duration-300 ${
    ...
    >
      ...
      {/* Content */}
      <div className="p-4 overflow-y-auto max-h-62.5">
        {/* Main answer */}
